	...
	<div id="main">
    	<div class="content page-order-payment">
    	    ...
    	    <div class="confirm-detail">
    	        ...
    	        <p class="info-detail">姓名：{{orderinfo.take.name}}</p>
    	        <p class="info-detail">联系电话：{{orderinfo.take.phone}}</p>  
    	        <p class="info-detail">
    	        详细地址：{{orderinfo.take.province}}{{orderinfo.take.city}}{{orderinfo.take.county}}
    	        </p>
    	    </div>
    	    <div class="confirm-detail">
